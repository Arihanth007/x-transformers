...
from Chemformer.molbart.data.datasets import UsptoFinetune
...
if __name__ == '__main__':
    ...
    model_file = '/scratch/arihanth.srikar/uspto50/pretrain_lora_cross_attn/model-epoch=969-val_accuracy=0.52424.ckpt'
    model = Chemformer.load_from_checkpoint(model_file, config=config)
