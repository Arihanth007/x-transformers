...
class XTModel(pl.LightningModule):
    ...
    def forward(self, batch):
        reactants, products, mask, reactant_bfs_pos, reactant_dfs_pos, product_bfs_pos, product_dfs_pos, mol_id = batch
        logits, loss = self.model(products, reactants, mask=mask, 
                                    react_pos=[reactant_bfs_pos, reactant_dfs_pos],
                                    prod_pos=[product_bfs_pos, product_dfs_pos])
        return logits, loss
    ...
    def predict_step(self, batch, batch_idx):
        reactants, products, src_mask, reactant_bfs_pos, reactant_dfs_pos, product_bfs_pos, product_dfs_pos, mol_id = batch
